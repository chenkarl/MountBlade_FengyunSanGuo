...
#          (try_end),
  ...
  ("mod_option",0,
   ...
   [],[ 
      ...
      ("cheat1",[(eq, "$cheat_mode",0)],"enable cheat",
       [(assign, "$cheat_mode",1),
        ]),
	   
      ("cheat2",[(eq, "$cheat_mode",1)],"disable cheat",
       [(assign, "$cheat_mode",0),
        ]),
		
      ("disable_npc_complaints",[(eq, "$disable_npc_complaints", 0),],"Close npc complaints.",
      [(assign, "$disable_npc_complaints", 1),]),

      ("enable_npc_complaints",[(eq, "$disable_npc_complaints", 1),],"Open npc complaints.",
