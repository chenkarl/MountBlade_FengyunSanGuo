...
skills = [
  ("trade","Trade",sf_base_att_cha|sf_effects_party,15,"Every level of this skill reduces your trade penalty by 5%%. (Party skill)  Max level: 15"),
  ("leadership","Leadership",sf_base_att_cha,15,"Every point increases maximum number of troops you can command by 5, increases your party morale and reduces troop wages by 5%%. (Leader skill)  Max level: 15"),
  ("prisoner_management", "Prisoner Management",sf_base_att_cha,15,"Every level of this skill increases maximum number of prisoners by %d. (Leader skill)  Max level: 15"), 
  ...
  ("persuasion","Persuasion", sf_base_att_int,15, "This skill helps you make other people accept your point of view. It also lowers the minimum level of relationship needed to get NPCs to do what you want. (Personal skill)  Max level: 15"),
  ("engineer","Engineer",sf_base_att_int|sf_effects_party,15,"This skill allows you to construct siege equipment and fief improvements more efficiently. (Party skill)  Max level: 15"),
  ("first_aid", "First Aid",sf_base_att_int|sf_effects_party,15,"Heroes regain 5%% per skill level of hit-points lost during mission. (Party skill)  Max level: 15"), 
  ("surgery","Surgery",sf_base_att_int|sf_effects_party,15,"Each point to this skill gives a 4%% chance that a mortally struck party member will be wounded rather than killed. (Party skill)  Max level: 15"), 
  ("wound_treatment","Wound Treatment",sf_base_att_int|sf_effects_party,15,"Party healing speed is increased by 20%% per level of this skill. (Party skill)  Max level: 15"), 
  ("inventory_management","Inventory Management",sf_base_att_int,15,"Increases inventory capacity by +6 per skill level. (Leader skill)  Max level: 15"), 
  ...
  ("pathfinding","Path-finding",sf_base_att_int|sf_effects_party,15,"Party map speed is increased by 3%% per skill level. (Party skill)  Max level: 15"), 
  ...
  ("trainer","Trainer",sf_base_att_int,15,"Every day, each hero with this skill adds some experience to every other member of the party whose level is lower than his/hers. Experience gained goes as: {0,4,10,16,23,30,38,46,55,65,80}. (Personal skill)  Max level: 15"),
  ...
  ("horse_archery","Horse Archery",sf_base_att_agi,15,"Reduces damage and accuracy penalties for archery and throwing from horseback. (Personal skill)  Max level: 15"),
  ("riding","Riding",sf_base_att_agi,15,"Enables you to ride horses of higher difficulty levels and increases your riding speed and manuever. (Personal skill)  Max level: 15"),
  ("athletics","Athletics",sf_base_att_agi,15,"Improves your running speed. (Personal skill)  Max level: 15"),
  ("shield","Shield",sf_base_att_agi,15,"Reduces damage to shields (by 8%% per skill level) and improves shield speed and coverage. (Personal skill)  Max level: 15"),
  ("weapon_master","Weapon Master",sf_base_att_agi,15,"Makes it easier to learn weapon proficiencies and increases the proficiency limits. Limits go as: 60, 100, 140, 180, 220, 260, 300, 340, 380, 420. (Personal skill)  Max level: 15"),
  ...
  ("ironflesh","Ironflesh",sf_base_att_str,15,"Each point to this skill increases hit points by +2. (Personal skill)  Max level: 15"), 
