...
##   [1.0, "fysg_jump02", 22, 46, arf_blend_in_1],
...
#   [0.8, "run_normal", 0, 12, arf_use_walk_progress|arf_cyclic|blend_in_walk,pack2f(0.4,0.9)], 
   ...
   [0.8, "fysg_one_run_01", 0, 24, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
##   [0.8, "fysg_one_run", 0, 24, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
 ],
...
##   [4.0, "anim_human", horse_move + 5000, horse_move + 5057, arf_lancer|arf_cyclic],
   [43.0, "fysg_qima02", 0, 1300, arf_lancer|arf_cyclic],
 ],
...
####### TU #### 2014.1.9 ###
 ["unused_human_anim_44", acf_enforce_all, amf_priority_continue|amf_client_prediction|amf_keep,
   [4, "tuiche", 0, 26, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25], 
 ],
 ["unused_human_anim_45", acf_enforce_all,  amf_priority_continue|amf_client_prediction|amf_play,
   [0.1, "tuiche", 0, 1, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25], 
 ],
 ["unused_human_anim_46", acf_enforce_lowerbody | acf_synch_with_horse, amf_priority_continue|amf_client_prediction|amf_keep,
   [0.5, "anim_human_02", 150, 165, arf_cyclic|arf_blend_in_32], 
 ],
 ["unused_human_anim_47", acf_enforce_lowerbody | acf_synch_with_horse, amf_priority_continue|amf_client_prediction|amf_play,
   [0.1, "anim_human_02", 150, 165, arf_cyclic|arf_blend_in_32], 
 ],
 ["unused_human_anim_48", acf_left_cut|acf_rot_vertical_sword|acf_anim_length(100), amf_priority_continue|amf_client_prediction|amf_play|amf_priority_die,
   [0.7, "attacks_staff_lefttoright", 16, 41, blend_in_release], 
 ],
...
##   [2.5, "anim_horse", 505, 580,  arf_blend_in_8],
 ...
 ["unused_horse_anim_1", acf_enforce_lowerbody, amf_priority_continue|amf_client_prediction|amf_keep,
   [0.5, "anim_horse", 150, 165, arf_cyclic|arf_use_walk_progress|arf_make_walk_sound,pack4f(0.4,0.31,0.79,0.94), (0, 0, 0), 0.2],
 ],
 ["unused_horse_anim_2", acf_enforce_lowerbody, amf_priority_continue|amf_client_prediction|amf_play,
   [0.1, "anim_horse", 150, 165, arf_cyclic|arf_use_walk_progress|arf_make_walk_sound,pack4f(0.4,0.31,0.79,0.94), (0, 0, 0), 0.2],
 ],
...
####### TU ####### module_animations ################
  ["tu_stand_single", 0, amf_priority_die|amf_client_prediction,
   [9.0, "sword_loop01", 0, 200, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25], 
 ],
 
  # ["tu_zuoxia_1", 0, amf_priority_die|amf_client_prediction,
   # [5, "zuoxia", 0, 60, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25], 
 # ],
 
  # ["tu_zuoxia_2", 0, amf_priority_die|amf_client_prediction,
   # [10, "zuoxia", 20, 79, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25], 
   # # [2.2, "anim_human", blow+200, blow+275, arf_blend_in_3|arf_make_custom_sound, pack2f(0.8, 0.0), (0,0,0), 0.3], 
 # ],

  # ["tu_zuoxia_3", 0, amf_priority_die|amf_client_prediction,
   # [2, "zuoxia", 80, 90, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25], 
   # # [2.2, "anim_human", blow+200, blow+275, arf_blend_in_3|arf_make_custom_sound, pack2f(0.8, 0.0), (0,0,0), 0.3], 
 # ],
 
  # ["tu_xiaobing_1", 0, amf_priority_die|amf_client_prediction,
   # [10, "xiaobingbaogao", 0, 60, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25], 
   # # [2.2, "anim_human", blow+200, blow+275, arf_blend_in_3|arf_make_custom_sound, pack2f(0.8, 0.0), (0,0,0), 0.3], 
 # ],
 
  # ["tu_xiaobing_2", 0, amf_priority_die|amf_client_prediction,
   # [10, "xiaobingbaogao", 60, 130, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25], 
   # # [2.2, "anim_human", blow+200, blow+275, arf_blend_in_3|arf_make_custom_sound, pack2f(0.8, 0.0), (0,0,0), 0.3], 
 # ],
 
  # ["tu_xiaobing_3", 0, amf_priority_die|amf_client_prediction,
   # [10, "xiaobingbaogao", 130, 185, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25], 
   # # [2.2, "anim_human", blow+200, blow+275, arf_blend_in_3|arf_make_custom_sound, pack2f(0.8, 0.0), (0,0,0), 0.3], 
 # ],

  ["tu_zuoxia_1", 0, amf_priority_die|amf_client_prediction,
   [4, "zuoxia", 0, 25, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25], 
 ],
 
  ["tu_zuoxia_2", 0, amf_priority_die|amf_client_prediction,
   [2, "zuoxia", 80, 120, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [2, "zuoxia", 80, 120, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [2, "zuoxia", 80, 120, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [3, "zuoxia", 120, 195, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   # [2.2, "anim_human", blow+200, blow+275, arf_blend_in_3|arf_make_custom_sound, pack2f(0.8, 0.0), (0,0,0), 0.3], 
 ],

  ["tu_zuoxia_3", 0, amf_priority_die|amf_client_prediction,
   [2, "zuoxia", 204, 214, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25], 
   # [2.2, "anim_human", blow+200, blow+275, arf_blend_in_3|arf_make_custom_sound, pack2f(0.8, 0.0), (0,0,0), 0.3], 
 ],
 
  ["tu_xiaobing_1", 0, amf_priority_die|amf_client_prediction,
   [3, "xiaobingbaogao", 0, 30, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25], 
   # [2.2, "anim_human", blow+200, blow+275, arf_blend_in_3|arf_make_custom_sound, pack2f(0.8, 0.0), (0,0,0), 0.3], 
 ],
 
  ["tu_xiaobing_2", 0, amf_priority_die|amf_client_prediction,
   [10, "xiaobingbaogao", 30, 166, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25], 
   # [2.2, "anim_human", blow+200, blow+275, arf_blend_in_3|arf_make_custom_sound, pack2f(0.8, 0.0), (0,0,0), 0.3], 
 ],
 
  ["tu_xiaobing_3", 0, amf_priority_die|amf_client_prediction,
   [2, "xiaobingbaogao", 167, 185, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25], 
   # [2.2, "anim_human", blow+200, blow+275, arf_blend_in_3|arf_make_custom_sound, pack2f(0.8, 0.0), (0,0,0), 0.3], 
 ],
 
  ["tu_baoquan_1", 0, amf_priority_die|amf_client_prediction,
   [2, "baoquan", 0, 89, arf_use_stand_progress, 0, (0, 0, 0), 0.25], 
   # [2.2, "anim_human", blow+200, blow+275, arf_blend_in_3|arf_make_custom_sound, pack2f(0.8, 0.0), (0,0,0), 0.3], 
 ],
 
  ["tu_baoquan_2", 0, amf_priority_attack|amf_client_prediction,
   [2, "baoquan", 44, 54, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25], 
 ],
###############
 ]
